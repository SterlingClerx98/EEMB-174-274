...
Note that the paper can be accessed through the UCSB library portal using your UCSB net id to get access.
...
The datafram has 236 observations of 61 unique fish groups (labeled by Anemone_ID). Anemone size is taken to represent the food-richness of the area the fish live in, so anemone size might influence fish health and therefore fish reproductive output. 
...
### (6) List two "big world" explanations for why the data show more variability than the model fit does.
