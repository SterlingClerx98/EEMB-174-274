...
# Put plot code here
```
From these plots how well do you think that area in this linear model predicts fox weight?

< Type answer here >

### Does food level affect fox weight?

Repeat everything you did above but now with food level (F) instead of weight.
...
Now make a plot that compares the mean weights (mu) that the model predicts against the actual weights of each group.
